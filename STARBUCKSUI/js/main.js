...
// 화면 스크롤이 일정길이 이상 길어지면 Badgerk Scroll되도록 :GSAP 애니메이션 효과를 주도록
...
//커피이미지가 시간차를 두고 화면에 순차척으로 표현되도록 애니메이션 효과를 주도록
...
new Swiper('.promotion .swiper-container', {
    ...
    autoplay: { delay: 5000 }, // 5초마다 슬라이더가 바뀌도록
    loop: true, //반복재생
